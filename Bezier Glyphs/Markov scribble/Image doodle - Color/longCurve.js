class Scribble{
    ...
    constructor(lkMat,col){

        this.lkMat = lkMat;
        this.nCurves = 10 // Number of curves 
        this.std = random(2,20);
        this.initCurve();

       

        this.strWt = map(this.std,2,20,1.5,0.1);  // Stroke weight
        this.strCol = col // Stroke color
    ...
    getValidPoint(v){
        ...
        this.std = abs(randomGaussian(map(lk2,0,255,20,10),10));
        this.strWt = map(this.std,2,20,1,0.1);
