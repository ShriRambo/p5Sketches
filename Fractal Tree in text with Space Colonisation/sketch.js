...
function setup() {
    Cannvass = createCanvas(592,331);
   // randomSeed(999);
    tree = new Tree();
    console.log("Getting valid points");
    getValidPoints();
...
function getValidPoints(){
    ...
    img.loadPixels();
    console.log("IN getting valid points");
    for(var x = 0; x < img.width; x++){
        ...
        for (var y = 0; y < img.height; y++){
            ...
            index = x + y*img.width;
            //console.log(index);
            //var c = img.pixels[index];
            //console.log(c);
            //var b = brightness(c);
            if( img.pixels[index] < 50){
                console.log(index);
                validPoints.push(createVector(i,j) );
            }
        }
    }
    console.log("GOt valid points.");
