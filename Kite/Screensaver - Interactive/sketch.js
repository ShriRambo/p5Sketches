...
class Kite{
    ...
    update(){
        ...
        // this.dir.x += this.xyForce.x / this.speed;
        // this.dir.y += this.xyForce.y / this.speed;
        ...
        // Yawing
        let dxVec = createVector(this.center.x - mouseX, this.center.y - mouseY)
        this.yawForce = this.dir.angleBetween(dxVec);

        let netF = this.yawForce - this.yaw
        let mltplyr = 10*Math.exp(-dxVec.mag()/10)
        this.yaw = this.yaw + netF * mltplyr;
        this.dir.rotate(0.01*this.yaw)
